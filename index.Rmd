...
knitr::include_graphics("https://i1.rgstatic.net/publication/319911820_An_evaluation_of_the_effects_of_intensity_and_duration_on_outcomes_across_treatment_domains_for_children_with_autism_spectrum_disorder/links/5fb392bc45851518fdacd42a/largepreview.png")
```
...
Linstead, Dixon, Hong, Burns, French, Novack, and Granspeesheh (2017) conducted a study to investigate treatment approach via Applied Behavior Analysis (ABA). The researchers aimed to explore if treatment **intensity** (treatment hours) and **duration** (months in treatment) influence specific learning outcomes (academic, adaptive, cognitive, executive function, language, motor, play, and social) ine eight domains. 

A total of 1,468 participants (18-mths to 12-yo) diagnosed with autism or pervasive development disorder-not otherwise specified (PDD-NOS) were recruited for this study. 

Results indicated that treatment intensity and duration interacted across all eight treatment domains. They further concluded that academic and language categories had the most robust interaction.
---
```{r, out.width = "150px", fig.align='right'}
knitr::include_graphics("https://i.pinimg.com/originals/4c/78/65/4c78654be43dc14f7509346806361a68.png")
```
...
.pull-left[
Below are the adjusted means for each:
  - adaptive = 5.95 hrs
  - academic = 10.55 hrs
  - cognitive = 6.38 hrs
...
* The authors also reported on unstandardized regression parameters, Table 1 because they wanted to compare each effect of x and Y. They did this after running a regression model on variables measured in their raw state.

```{r, out.width= "400px"}
knitr::include_graphics("https://kgeovanni.github.io/presentation2/table.png")
```
---
```{r, out.width = "150px", fig.align='right'}
knitr::include_graphics("https://i.pinimg.com/originals/4c/78/65/4c78654be43dc14f7509346806361a68.png")
